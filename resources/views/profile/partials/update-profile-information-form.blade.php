    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <label for="notifications" class="inline-flex items-center">
                <input id="notifications" name="notifications_enabled" value="1" type="checkbox" class="form-checkbox" {{ $user->notifications_enabled ? 'checked' : '' }}>
                <span class="ml-2">{{ __('Enable On-Screen Notifications') }}</span>
            </label>
